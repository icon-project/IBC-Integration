module github.com/icon-project/ibc-integration
...
require (
	...
	github.com/cosmos/ibc-go v0.0.0-00010101000000-000000000000
...
replace (
	...
	github.com/cosmos/ibc-go => github.com/cosmos/ibc-go/v8 v8.0.1
