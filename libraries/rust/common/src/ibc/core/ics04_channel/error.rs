...
use crate::ibc::core::ics04_channel::channel::State;
use crate::ibc::core::ics05_port::error as port_error;
use crate::ibc::core::ics24_host::error::ValidationError;
use crate::ibc::core::ics24_host::identifier::{ChannelId, ClientId, ConnectionId, PortId};
...
pub enum PacketError {
    ...
    InvalidPacketTimestamp(crate::ibc::timestamp::ParseTimestampError),
    /// identifier error: `{0}`
    Identifier(ValidationError),
