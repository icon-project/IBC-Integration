...
impl ChainId {
    ...
    /// ```
    /// use crate::common::ibc::core::ics24_host::identifier::ChainId;
    ///
    /// let epoch_number = 10;
...
#[derive(Clone, Debug, PartialEq, Eq, PartialOrd, Ord, Hash, Into, Serialize, Deserialize)]
...
impl ClientId {
    ...
    ///
    /// ```
    /// # use crate::common::ibc::core::ics24_host::identifier::ClientId;
    /// # use crate::common::ibc::core::ics02_client::client_type::ClientType;
...
impl Default for ClientId {
    fn default() -> Self {
        Self::new(ClientType::default(), 0).unwrap()
    }
}
...
impl ConnectionId {
    ...
    ///
    /// ```
    /// # use crate::common::ibc::core::ics24_host::identifier::ConnectionId;
...
impl ChannelId {
    ...
    ///
    /// ```
    /// # use crate::common::ibc::core::ics24_host::identifier::ChannelId;
