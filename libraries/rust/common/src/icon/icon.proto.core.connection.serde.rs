...
impl serde::Serialize for MerklePrefix {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("icon.proto.core.connection.MerklePrefix", len)?;
        if !self.key_prefix.is_empty() {
...
impl<'de> serde::Deserialize<'de> for MerklePrefix {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct icon.proto.core.connection.MerklePrefix")
            }
        ...
        deserializer.deserialize_struct("icon.proto.core.connection.MerklePrefix", FIELDS, GeneratedVisitor)
    }
}
