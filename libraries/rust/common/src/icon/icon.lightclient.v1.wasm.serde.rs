...
impl serde::Serialize for ClientState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("icon.lightclient.v1.wasm.ClientState", len)?;
        if !self.data.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ClientState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct icon.lightclient.v1.wasm.ClientState")
            }
        ...
        deserializer.deserialize_struct("icon.lightclient.v1.wasm.ClientState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for ConsensusState {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("icon.lightclient.v1.wasm.ConsensusState", len)?;
        if !self.data.is_empty() {
            struct_ser.serialize_field("data", pbjson::private::base64::encode(&self.data).as_str())?;
        }
        if !self.code_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for ConsensusState {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct icon.lightclient.v1.wasm.ConsensusState")
            }
        ...
        deserializer.deserialize_struct("icon.lightclient.v1.wasm.ConsensusState", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Header {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("icon.lightclient.v1.wasm.Header", len)?;
        if !self.data.is_empty() {
            struct_ser.serialize_field("data", pbjson::private::base64::encode(&self.data).as_str())?;
        }
...
impl<'de> serde::Deserialize<'de> for Header {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct icon.lightclient.v1.wasm.Header")
            }
        ...
        deserializer.deserialize_struct("icon.lightclient.v1.wasm.Header", FIELDS, GeneratedVisitor)
    }
}
impl serde::Serialize for Misbehaviour {
        ...
        S: serde::Serializer,
    {
        ...
        let mut struct_ser = serializer.serialize_struct("icon.lightclient.v1.wasm.Misbehaviour", len)?;
        if !self.client_id.is_empty() {
...
impl<'de> serde::Deserialize<'de> for Misbehaviour {
        ...
        D: serde::Deserializer<'de>,
    {
        ...
        impl<'de> serde::de::Visitor<'de> for GeneratedVisitor {
            ...
            fn expecting(&self, formatter: &mut std::fmt::Formatter<'_>) -> std::fmt::Result {
                formatter.write_str("struct icon.lightclient.v1.wasm.Misbehaviour")
            }
        ...
        deserializer.deserialize_struct("icon.lightclient.v1.wasm.Misbehaviour", FIELDS, GeneratedVisitor)
    }
}
