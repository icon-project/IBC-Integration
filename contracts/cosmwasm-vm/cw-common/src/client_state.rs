...
use crate::ibc_types::IbcClientId;
use crate::ibc_types::IbcClientState;
use crate::ibc_types::IbcClientType;
use crate::ibc_types::IbcConnectionEnd;
use crate::ibc_types::IbcHeight;
...
use crate::constants::ICON_CLIENT_STATE_TYPE_URL;
...
impl IbcClientState for ClientState {
    ...
    fn verify_connection_state(
        ...
        expected_counterparty_connection_end: &IbcConnectionEnd,
    ) -> Result<(), ClientError> {
        todo!()
    }
